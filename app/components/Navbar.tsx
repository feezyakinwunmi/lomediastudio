      ...
      >
        ...
        <div className="relative">
          ...
          <motion.div
            animate={{
              background: [
                "radial-gradient(circle at 20% 50%, rgba(239, 68, 68, 0.1) 0%, rgba(255, 255, 255, 0.8) 100%)",
                "radial-gradient(circle at 80% 50%, rgba(239, 68, 68, 0.1) 0%, rgba(255, 255, 255, 0.8) 100%)",
                "radial-gradient(circle at 20% 50%, rgba(239, 68, 68, 0.1) 0%, rgba(255, 255, 255, 0.8) 100%)",
              ],
            }}
            transition={{
                ...
                {navItems.map((item) => (
                  <Link key={item.name} href={item.href}>
                    <motion.div
                      ...
                      whileHover={{ scale: 1.05 }}
                      animate={{
                        backgroundColor: hoveredItem === item.name 
                          ? "rgba(239, 68, 68, 0.15)" 
                          : "rgba(255, 255, 255, 0)",
                      }}
                      className="relative px-4 py-2 rounded-full transition-all duration-300 cursor-pointer"
                    >
                      <span className="relative text-gray-700 hover:text-red-500 transition-colors font-medium">
                        {item.name}
                      </span>
              ...
              {navItems.map((item) => (
                <Link key={item.name} href={item.href}>
                  <motion.div
                    ...
                    className="px-4 py-3 text-gray-700 hover:text-red-500 transition-colors rounded-lg"
