    ...
    <div className="space-y-20">
      ...
      <div>
        <div className="flex items-start gap-5 mb-8">
          <div className="w-12 h-12 bg-pink-100 rounded-2xl flex items-center justify-center flex-shrink-0 mt-1">
        ...
        <ul className="list-disc pl-6 space-y-3 text-gray-600 mt-6">
          <li>Local customers actively searching for services</li>
          <li>Younger audiences consuming short-form video daily</li>
          <li>Potential clients who trust visual storytelling more than ads</li>
      ...
      <div>
        <div className="flex items-start gap-5 mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900">The Biggest Mistake Ottawa Brands Make With Reels</h2>
        </div>
        <div className="prose prose-lg text-gray-600 leading-relaxed">
          <p>Most businesses think posting random trending videos is enough. It is not.</p>
          <p>A reel without strategy is just entertainment. A reel with strategy becomes a conversion tool.</p>
          <p>The problem is that many brands:</p>
        </div>
        <ul className="list-disc pl-6 space-y-3 text-gray-600 mt-6">
          <li>Copy trends without relevance</li>
          <li>Post inconsistent content</li>
          <li>Ignore storytelling</li>
          <li>Use weak hooks</li>
          <li>Lack clear calls-to-action</li>
          <li>Fail to optimize for local audiences</li>
        </ul>
      ...
      <div>
        <h2 className="text-3xl font-bold text-gray-900 mb-10">What Makes an Instagram Reel Convert?</h2>
        <div className="prose prose-lg text-gray-600 leading-relaxed space-y-12">
          
          <div>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">1. Strong First 3 Seconds</h3>
          ...
          <div>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">3. Storytelling Over Selling</h3>
            <p>People do not connect with ads. They connect with stories. The best reels show behind-the-scenes moments, highlight transformations, share customer experiences, teach something useful, and make the audience feel understood.</p>
          </div>
      ...
      {/* Types of Reels */}
      <div>
        <h2 className="text-3xl font-bold text-gray-900 mb-10">Types of Reels That Work Best for Ottawa Brands</h2>
        
        <div className="space-y-12">
          <div>
            <h3 className="text-xl font-semibold mb-4">Educational Reels</h3>
            <p className="text-gray-600">Teach your audience something valuable related to your industry. Examples: Real estate tips for Ottawa buyers, social media hacks for local businesses, fitness advice, legal or financial quick tips.</p>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-4">Behind-the-Scenes Reels</h3>
            <p className="text-gray-600">Authenticity builds trust faster than polished commercials. Show team culture, content creation, product preparation, day-to-day business operations.</p>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-4">Client Transformation Reels</h3>
            <p className="text-gray-600">Before-and-after content performs extremely well because people love visible results. Perfect for beauty brands, fitness studios, interior designers, marketing agencies, home improvement companies.</p>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-4">Trend-Based Reels With Strategy</h3>
      ...
      <div>
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Why Ottawa Businesses Need Professional Reel Strategy</h2>
      ...
      {/* Final CTA */}
      <div className="bg-gradient-to-br from-pink-600 to-rose-600 text-white rounded-3xl p-16 text-center">
        <Award className="w-16 h-16 mx-auto mb-6" />
        <h3 className="text-3xl font-bold mb-4">Ready to Grow Your Ottawa Brand With Instagram Reels?</h3>
