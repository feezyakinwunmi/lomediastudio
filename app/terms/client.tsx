  ...
  const sections = [
    {
      ...
      content: [
        "By accessing or using LoMediaStudio's services, you agree to be bound by these Terms of Service.",
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          >
            <p className="text-gray-600 leading-relaxed">
              Welcome to LoMediaStudio. These Terms of Service govern your use of our website and services. 
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              ...
              with these terms shall be subject to the exclusive jurisdiction of the courts located in Ottawa, Ontario.
            </p>
